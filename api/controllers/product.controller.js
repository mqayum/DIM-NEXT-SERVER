...
const getProductsByPage = async (req, res) => {
    try{
        let {page} = req.query
        let products = await Product.getAllByPageNo(page)
...
module.exports = {addProduct, getProductById, updateProduct, deleteProduct, getListedProducts, getProductsByPage}